    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pub_jp', models.CharField(max_length=20, null=True)),
                ('pub_en', models.CharField(max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.series')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
